...
export function EmailToBoardDialog({ children }: { children: React.ReactNode }) {
  ...
  const copyToClipboard = (text: string) => {
    ...
    toast({
      title: "Copiado!",
      description: "O endere?o foi copiado para sua ?rea de transfer?ncia.",
    })
  }
        ...
        <div className="p-6 space-y-6">
          <DialogHeader>
            <div className="flex items-center justify-between">
              <DialogTitle className="text-lg font-semibold text-gray-100">Adicionar Cart?es via Email</DialogTitle>
            </div>
            <DialogDescription className="text-gray-400 text-xs">
              Use este endere?o para criar briefings automaticamente a partir de formul?rios do seu site.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label className="text-[11px] font-bold uppercase text-gray-500 tracking-wider">
                Endere?o de e-mail para este quadro
              </Label>
            ...
            <div className="space-y-3 pt-2 border-t border-gray-800">
              <Button variant="link" className="text-blue-400 p-0 h-auto text-xs flex items-center gap-2 hover:no-underline">
                Redefinir endere?o de e-mail
              </Button>
              <Button variant="link" className="text-blue-400 p-0 h-auto text-xs flex items-center gap-2 hover:no-underline">
                Enviar este endere?o por e-mail para mim
              </Button>
            </div>
            ...
            <div className="space-y-4 pt-2 border-t border-gray-800">
              <p className="text-[11px] font-bold uppercase text-gray-500 tracking-wider">
                Seus cart?es enviados por email aparecem em...
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  <Label className="text-[10px] text-gray-400">Posi??o</Label>
